          ...
          <div class="card card-info card-outline">
            <div class="card-body box-profile">
              <div class="text-center">
                ...
                src="{{ asset('storage/profiles/' . $business->profile) }}"
                     alt="User profile picture">
              </div>

              <h3 class="profile-username text-center">{{ $user->name }} / {{ $business->businessname }}</h3>

              <p class="text-muted text-center">{{ $business->businessnumber }}</p>
              <p class="text-muted text-center">{{ $business->industry }} {{ $business->dateofregistration }}</p>
            ...
            <div class="card-body">
              <div class="tab-content">
                ...
                <div class="tab-pane fade {{ $redirectToTab === 'timeline' ? 'active' : '' }}" id="timeline">
                  <!-- The timeline -->
                    <form class="form-horizontal" method="POST" action="{{ route('business.profile.profile') }}">
                      @csrf
                      @method('PUT')
                ...
                <div class="tab-pane fade {{ $redirectToTab === 'settings' ? 'active' : '' }}" id="settings">
                    <form class="form-horizontal" method="POST" action="{{ route('business.profile.profile') }}">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="businessname" id="businessname" class="form-control" value="{{ $business->businessname }}">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">Phone Number</label>
                        <div class="col-sm-10">
                          <input type="text" name="phone" id="phone" class="form-control" value="{{ $business->phone }}">
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="industry" id="industry" class="form-control" value="{{ $business->industry }}">
                        </div>
                      </div>
                      <div class="form-group row">
                        <div class="offset-sm-2 col-sm-10">

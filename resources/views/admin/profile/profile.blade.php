        ...
        <div class="col-md-3">
          ...
          <div class="card card-info card-outline">
            <div class="card-body box-profile">
              ...
              <h3 class="profile-username text-center">{{ $user->name }} {{ $admin->lname }} {{ $admin->surname }}</h3>

              <p class="text-muted text-center">{{ $admin->idnumber }}</p>
              <p class="text-muted text-center">{{ $admin->gender }} {{ $admin->dob }}</p>
            ...
            <div class="card-body">
              <div class="tab-content">
                ...
                <div class="tab-pane fade {{ $redirectToTab === 'timeline' ? 'active' : '' }}" id="timeline">
                  <!-- The timeline -->
                    <form class="form-horizontal" method="POST" action="{{ route('admin.profile.profile') }}">
                      @csrf
                      @method('PUT')
                ...
                <div class="tab-pane fade {{ $redirectToTab === 'settings' ? 'active' : '' }}" id="settings">
                    <form class="form-horizontal" method="POST" action="{{ route('admin.profile.profile') }}">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="lname" id="lname" class="form-control" value="{{ $admin->lname }}">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">Surname</label>
                        <div class="col-sm-10">
                          <input type="text" name="surname" id="surname" class="form-control" value="{{ $admin->surname }}">
                        </div>
                      </div>
                      <div class="form-group row">

        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
             <form method="POST" action="{{ route('nonresident.dashboard') }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input id="passportnumber" type="text" class="form-control" name="passportnumber" required>
                            </div>
                        </div>
                            <div class="col-md-6">
                                <div class="form-group">

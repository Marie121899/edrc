      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><button class="btn btn-info"><a  style="color: #fff;" href="{{ url('citizen/taxes/create')}}">File Return</a></button></li>
            </ol>
        </div><!-- /.col -->
      </div>
    </div><!-- /.container-fluid -->
                ...
                <tr>
                    ...
                    <td>
                      ...
                      <span class="{{ $statusClass }}">{{ $statusText }}</span>
                            ...
                            <td>{{ $tax->tax_year }}</td>
                            <td>
                                <a href="{{ route('citizen.taxes.show', $tax->id) }}" class="btn btn-warning">View</a>
                            </td>
                </tr>
                @endforeach
                @else
